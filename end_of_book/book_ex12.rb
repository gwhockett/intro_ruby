...
puts "Joe can be contacted via the following email address: #{contacts["Joe Smith"][:email]}"
puts "Sally can be reached at the following phone number: #{contacts["Sally Johnson"][:phone]}"